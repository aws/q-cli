/* Autogenerated by generate-requests.ts on 9/26/2023
...
export async function sendAuthBuilderIdInitRequest(
  request: AuthBuilderIdInitRequest
): Promise<AuthBuilderIdInitResponse> {
  return new Promise((resolve, reject) => {
    sendMessage(
      { $case: "authBuilderIdInitRequest", authBuilderIdInitRequest: request },
      (response) => {
        switch (response?.$case) {
          case "authBuilderIdInitResponse":
            resolve(response.authBuilderIdInitResponse);
            break;
          case "error":
            reject(Error(response.error));
            break;
          default:
            reject(
              Error(
                `Invalid response '${response?.$case}' for 'AuthBuilderIdInitRequest'`
              )
            );
        }
      }
...
export async function sendAuthBuilderIdPollRequest(
  request: AuthBuilderIdPollRequest
): Promise<AuthBuilderIdPollResponse> {
  return new Promise((resolve, reject) => {
    sendMessage(
      { $case: "authBuilderIdPollRequest", authBuilderIdPollRequest: request },
      (response) => {
        switch (response?.$case) {
          case "authBuilderIdPollResponse":
            resolve(response.authBuilderIdPollResponse);
            break;
          case "error":
            reject(Error(response.error));
            break;
          default:
            reject(
              Error(
                `Invalid response '${response?.$case}' for 'AuthBuilderIdPollRequest'`
              )
            );
        }
      }
