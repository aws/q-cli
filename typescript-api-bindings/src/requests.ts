/* Autogenerated by generate-requests.ts on 3/7/2022
          ...
          default:
            reject(
              Error(
                `Invalid response '${ 
                  response?.$case 
                  }' for 'TerminalSessionInfoRequest'`
              )
            );
        }
      }
          ...
          default:
            reject(
              Error(
                `Invalid response '${ 
                  response?.$case 
                  }' for 'ApplicationUpdateStatusRequest'`
              )
            );
        }
      }
