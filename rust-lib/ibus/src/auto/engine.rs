...
impl Engine {
    ...
    ///
    /// This method returns an instance of [`EngineBuilder`](crate::builders::EngineBuilder) which
    /// can be used to create [`Engine`] objects.
...
impl Default for Engine {
    fn default() -> Self {
        glib::object::Object::new::<Self>(&[]).expect("Can't construct Engine object with default parameters")
    }
}
...
pub trait EngineExt: 'static {
    ...
    // fn update_preedit_text_with_mode(&self, text: /*Ignored*/&Text, cursor_pos: u32, visible: bool,
    // mode: /*Ignored*/PreeditFocusMode);
    ...
    // fn connect_process_hand_writing_event<Unsupported or ignored types>(&self, f: F) ->
    // SignalHandlerId;
...
impl<O: IsA<Engine>> EngineExt for O {
    ...
    // fn update_preedit_text_with_mode(&self, text: /*Ignored*/&Text, cursor_pos: u32, visible: bool,
    // mode: /*Ignored*/PreeditFocusMode) {    unsafe { TODO: call
    // ffi:ibus_engine_update_preedit_text_with_mode() }
    //}
    ...
    fn connect_cancel_hand_writing<F: Fn(&Self, u32) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn cancel_hand_writing_trampoline<P: IsA<Engine>, F: Fn(&P, u32) + 'static>(
    ...
    fn connect_candidate_clicked<F: Fn(&Self, u32, u32, u32) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn candidate_clicked_trampoline<P: IsA<Engine>, F: Fn(&P, u32, u32, u32) + 'static>(
            this: *mut ffi::IBusEngine,
            index: libc::c_uint,
            button: libc::c_uint,
            state: libc::c_uint,
    ...
    // fn connect_process_hand_writing_event<Unsupported or ignored types>(&self, f: F) ->
    // SignalHandlerId {    Unimplemented coordinates: *.Pointer
    //}
    ...
    fn connect_property_activate<F: Fn(&Self, &str, u32) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn property_activate_trampoline<P: IsA<Engine>, F: Fn(&P, &str, u32) + 'static>(
            this: *mut ffi::IBusEngine,
    ...
    fn connect_set_capabilities<F: Fn(&Self, u32) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn set_capabilities_trampoline<P: IsA<Engine>, F: Fn(&P, u32) + 'static>(
            this: *mut ffi::IBusEngine,
            caps: libc::c_uint,
            f: glib::ffi::gpointer,
        ) {
    ...
    fn connect_set_content_type<F: Fn(&Self, u32, u32) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn set_content_type_trampoline<P: IsA<Engine>, F: Fn(&P, u32, u32) + 'static>(
            this: *mut ffi::IBusEngine,
            purpose: libc::c_uint,
            hints: libc::c_uint,
            f: glib::ffi::gpointer,
    ...
    fn connect_set_cursor_location<F: Fn(&Self, i32, i32, i32, i32) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn set_cursor_location_trampoline<P: IsA<Engine>, F: Fn(&P, i32, i32, i32, i32) + 'static>(
            this: *mut ffi::IBusEngine,
            x: libc::c_int,
            y: libc::c_int,
            w: libc::c_int,
