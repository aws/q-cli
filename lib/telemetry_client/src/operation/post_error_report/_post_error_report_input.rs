...
impl PostErrorReportInput {
    /// Creates a new builder-style object to manufacture [`PostErrorReportInput`](crate::operation::post_error_report::PostErrorReportInput).
...
/// A builder for [`PostErrorReportInput`](crate::operation::post_error_report::PostErrorReportInput).
#[non_exhaustive]
...
impl PostErrorReportInputBuilder {
    ...
    /// Consumes the builder and constructs a [`PostErrorReportInput`](crate::operation::post_error_report::PostErrorReportInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::post_error_report::PostErrorReportInput, ::aws_smithy_http::operation::error::BuildError> {
