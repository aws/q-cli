...
impl PostMetricsInput {
    /// Creates a new builder-style object to manufacture [`PostMetricsInput`](crate::operation::post_metrics::PostMetricsInput).
...
impl PostMetricsInputBuilder {
    ...
    /// Consumes the builder and constructs a [`PostMetricsInput`](crate::operation::post_metrics::PostMetricsInput).
    pub fn build(self) -> ::std::result::Result<crate::operation::post_metrics::PostMetricsInput, ::aws_smithy_http::operation::error::BuildError> {
