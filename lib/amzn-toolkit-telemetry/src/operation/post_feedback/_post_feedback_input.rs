...
impl PostFeedbackInput {
    /// Creates a new builder-style object to manufacture [`PostFeedbackInput`](crate::operation::post_feedback::PostFeedbackInput).
...
impl PostFeedbackInputBuilder {
    ...
    /// Consumes the builder and constructs a [`PostFeedbackInput`](crate::operation::post_feedback::PostFeedbackInput).
    pub fn build(self) -> ::std::result::Result<crate::operation::post_feedback::PostFeedbackInput, ::aws_smithy_http::operation::error::BuildError> {
