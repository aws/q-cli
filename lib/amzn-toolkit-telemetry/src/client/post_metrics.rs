...
impl super::Client {
    ...
    ///   - [`client_id(impl Into<String>)`](crate::operation::post_metrics::builders::PostMetricsFluentBuilder::client_id) / [`set_client_id(Option<String>)`](crate::operation::post_metrics::builders::PostMetricsFluentBuilder::set_client_id): (undocumented)
