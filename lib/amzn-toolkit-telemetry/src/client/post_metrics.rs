...
impl super::Client {
    /// Constructs a fluent builder for the [`PostMetrics`](crate::operation::post_metrics::builders::PostMetricsFluentBuilder) operation.
    ///
    ...
    ///   - [`client_id(impl Into<String>)`](crate::operation::post_metrics::builders::PostMetricsFluentBuilder::client_id) / [`set_client_id(Option<String>)`](crate::operation::post_metrics::builders::PostMetricsFluentBuilder::set_client_id): A valid UUID is expected, and this should be unique per-client and reused across API calls.
    ...
    /// - On success, responds with [`PostMetricsOutput`](crate::operation::post_metrics::PostMetricsOutput)
    /// - On failure, responds with [`SdkError<PostMetricsError>`](crate::operation::post_metrics::PostMetricsError)
