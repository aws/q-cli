...
> {
    ...
    Err(match error_code {
        "ThrottlingException" => crate::operation::generate_assistant_response::GenerateAssistantResponseError::ThrottlingError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ValidationException" => crate::operation::generate_assistant_response::GenerateAssistantResponseError::ValidationError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "AccessDeniedException" => crate::operation::generate_assistant_response::GenerateAssistantResponseError::AccessDeniedError({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
