...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_profiles::builders::ListProfilesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_profiles::builders::ListProfilesFluentBuilder::set_max_results): (undocumented)
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_profiles::builders::ListProfilesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_profiles::builders::ListProfilesFluentBuilder::set_next_token): (undocumented)
    /// - On success, responds with
    ///   [`ListProfilesOutput`](crate::operation::list_profiles::ListProfilesOutput) with field(s):
    ///   - [`profiles(Option<Vec<Profile>>)`](crate::operation::list_profiles::ListProfilesOutput::profiles): (undocumented)
