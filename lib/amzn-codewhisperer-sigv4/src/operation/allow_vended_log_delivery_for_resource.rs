...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer
    for AllowVendedLogDeliveryForResourceRequestSerializer
{
    #[allow(
        unused_mut,
...
pub type AllowVendedLogDeliveryForResourceErrorKind = AllowVendedLogDeliveryForResourceError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for AllowVendedLogDeliveryForResourceError {
...
impl AllowVendedLogDeliveryForResourceError {
    ...
    /// Creates the `AllowVendedLogDeliveryForResourceError::Unhandled` variant from a
