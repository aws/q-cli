...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateCustomizationPermission {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssociateCustomizationPermission")
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for AssociateCustomizationPermissionResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for AssociateCustomizationPermissionRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for AssociateCustomizationPermissionEndpointParamsInterceptor {
...
pub type AssociateCustomizationPermissionErrorKind = AssociateCustomizationPermissionError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for AssociateCustomizationPermissionError {
...
impl ::aws_http::request_id::RequestId for crate::operation::associate_customization_permission::AssociateCustomizationPermissionError {
...
impl AssociateCustomizationPermissionError {
    ...
    /// Creates the `AssociateCustomizationPermissionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
