...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateCustomization {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CreateCustomization", "codewhisperer"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateCustomization")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(CreateCustomizationEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for CreateCustomizationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for CreateCustomizationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_customization::ser_create_customization_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateCustomizationEndpointParamsInterceptor {
...
pub type CreateCustomizationErrorKind = CreateCustomizationError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateCustomizationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_customization::CreateCustomizationError {
...
impl CreateCustomizationError {
    ...
    /// Creates the `CreateCustomizationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
