    ...
    > + ::std::marker::Unpin {
        ...
        ::aws_smithy_async::future::fn_stream::FnStream::new(move |tx| {
            ::std::boxed::Box::pin(async move {
                ...
                loop {
                    let resp =
                        crate::operation::list_customization_permissions::ListCustomizationPermissions::orchestrate(&runtime_plugins, input.clone())
                            .await;
                    // If the input member is None or it was an error
                    let done = match resp {
                        ::std::result::Result::Ok(ref resp) => {
                            let new_token = crate::lens::reflens_list_customization_permissions_output_next_token(resp);
...
impl ListCustomizationPermissionsPaginatorItems {
    ...
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_customization_permissions_output_permissions(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
