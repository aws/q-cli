...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListCustomizations {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListCustomizations", "codewhisperer"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListCustomizations")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(ListCustomizationsEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for ListCustomizationsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_customizations::ser_list_customizations_input(&input)?);
...
impl ListCustomizationsError {
    ...
    /// Creates the `ListCustomizationsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
