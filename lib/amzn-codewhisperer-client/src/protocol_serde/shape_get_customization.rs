...
pub fn ser_get_customization_input(
    ...
    crate::protocol_serde::shape_get_customization_input::ser_get_customization_input(&mut object, input)?;
    object.finish();
...
) -> Result<crate::operation::get_customization::builders::GetCustomizationOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
