...
/// Configuration for a amzn_codewhisperer_bearer service client.
///
///
...
impl Builder {
    ...
    ///
    /// use amzn_codewhisperer_bearer::config::Config;
    ...
    /// }
    ///
    /// let mut builder = amzn_codewhisperer_bearer::Config::builder();
    ...
    /// resolution rules for `amzn_codewhisperer_bearer`.
    ...
    /// # Examples
    /// ```no_run
    /// use amzn_codewhisperer_bearer::config::retry::RetryConfig;
    /// use amzn_codewhisperer_bearer::config::Config;
    ///
    ...
    /// ```no_run
    /// # use std::time::Duration;
    /// use amzn_codewhisperer_bearer::config::timeout::TimeoutConfig;
    /// use amzn_codewhisperer_bearer::config::Config;
    ///
    ...
    pub fn build(mut self) -> Config {
        ...
        Config {
            config: ::aws_smithy_types::config_bag::Layer::from(layer.clone())
                .with_name("amzn_codewhisperer_bearer::config::Config")
                .freeze(),
            cloneable: layer,
    ...
    pub(crate) fn new(
        ...
        Self {
            config: ::aws_smithy_types::config_bag::Layer::from(layer)
                .with_name("amzn_codewhisperer_bearer::config::ConfigOverrideRuntimePlugin")
                .freeze(),
            components,
        }
    }
