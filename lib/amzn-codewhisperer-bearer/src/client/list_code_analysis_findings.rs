...
impl super::Client {
    ...
    ///   - [`job_id(impl Into<String>)`](crate::operation::list_code_analysis_findings::builders::ListCodeAnalysisFindingsFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::list_code_analysis_findings::builders::ListCodeAnalysisFindingsFluentBuilder::set_job_id): (undocumented)
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_code_analysis_findings::builders::ListCodeAnalysisFindingsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_code_analysis_findings::builders::ListCodeAnalysisFindingsFluentBuilder::set_next_token): (undocumented)
    ...
    ///   - [`code_analysis_findings(Option<String>)`](crate::operation::list_code_analysis_findings::ListCodeAnalysisFindingsOutput::code_analysis_findings): (undocumented)
