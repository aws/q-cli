...
impl super::Client {
    ...
    ///   - [`job_id(impl Into<String>)`](crate::operation::get_code_analysis::builders::GetCodeAnalysisFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::get_code_analysis::builders::GetCodeAnalysisFluentBuilder::set_job_id): (undocumented)
    /// - On success, responds with
    ///   [`GetCodeAnalysisOutput`](crate::operation::get_code_analysis::GetCodeAnalysisOutput) with
    ///   field(s):
    ///   - [`status(Option<CodeAnalysisStatus>)`](crate::operation::get_code_analysis::GetCodeAnalysisOutput::status): (undocumented)
