...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_available_customizations::builders::ListAvailableCustomizationsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_available_customizations::builders::ListAvailableCustomizationsFluentBuilder::set_max_results): (undocumented)
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_available_customizations::builders::ListAvailableCustomizationsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_available_customizations::builders::ListAvailableCustomizationsFluentBuilder::set_next_token): (undocumented)
    ...
    ///   - [`customizations(Option<Vec<Customization>>)`](crate::operation::list_available_customizations::ListAvailableCustomizationsOutput::customizations): (undocumented)
