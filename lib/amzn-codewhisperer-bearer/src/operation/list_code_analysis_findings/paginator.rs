    ...
    > + ::std::marker::Unpin {
        ...
        ::aws_smithy_async::future::fn_stream::FnStream::new(move |tx| {
            ::std::boxed::Box::pin(async move {
                ...
                loop {
                    let resp = crate::operation::list_code_analysis_findings::ListCodeAnalysisFindings::orchestrate(
                        &runtime_plugins,
                        input.clone(),
                    )
                    .await;
                    ...
                    let done = match resp {
                        ::std::result::Result::Ok(ref resp) => {
                            let new_token = crate::lens::reflens_list_code_analysis_findings_output_next_token(resp);
