...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartCodeAnalysis {
    ...
    fn runtime_components(
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartCodeAnalysis")
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for StartCodeAnalysisResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for StartCodeAnalysisRequestSerializer {
    #[allow(
        unused_mut,
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for StartCodeAnalysisEndpointParamsInterceptor {
...
pub type StartCodeAnalysisErrorKind = StartCodeAnalysisError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for StartCodeAnalysisError {
...
impl ::aws_http::request_id::RequestId for crate::operation::start_code_analysis::StartCodeAnalysisError {
...
impl StartCodeAnalysisError {
    ...
    /// Creates the `StartCodeAnalysisError::Unhandled` variant from a
