...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SendTelemetryEvent {
    ...
    fn runtime_components(
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SendTelemetryEvent")
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for SendTelemetryEventResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for SendTelemetryEventRequestSerializer {
    #[allow(
        unused_mut,
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for SendTelemetryEventEndpointParamsInterceptor {
...
pub type SendTelemetryEventErrorKind = SendTelemetryEventError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for SendTelemetryEventError {
...
impl ::aws_http::request_id::RequestId for crate::operation::send_telemetry_event::SendTelemetryEventError {
...
impl SendTelemetryEventError {
    ...
    /// Creates the `SendTelemetryEventError::Unhandled` variant from a
