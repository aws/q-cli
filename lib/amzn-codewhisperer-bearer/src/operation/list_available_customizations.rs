...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer
    for ListAvailableCustomizationsResponseDeserializer
{
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for ListAvailableCustomizationsRequestSerializer {
    #[allow(
        unused_mut,
...
pub type ListAvailableCustomizationsErrorKind = ListAvailableCustomizationsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListAvailableCustomizationsError {
...
impl ListAvailableCustomizationsError {
    ...
    /// Creates the `ListAvailableCustomizationsError::Unhandled` variant from a
