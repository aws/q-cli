...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetCodeAnalysis {
    ...
    fn runtime_components(
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetCodeAnalysis")
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for GetCodeAnalysisResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for GetCodeAnalysisRequestSerializer {
    #[allow(
        unused_mut,
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetCodeAnalysisEndpointParamsInterceptor {
...
pub type GetCodeAnalysisErrorKind = GetCodeAnalysisError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetCodeAnalysisError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_code_analysis::GetCodeAnalysisError {
...
impl GetCodeAnalysisError {
    ...
    /// Creates the `GetCodeAnalysisError::Unhandled` variant from a
