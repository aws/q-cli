...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GenerateCompletions {
    ...
    fn runtime_components(
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GenerateCompletions")
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for GenerateCompletionsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for GenerateCompletionsRequestSerializer {
    #[allow(
        unused_mut,
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GenerateCompletionsEndpointParamsInterceptor {
...
pub type GenerateCompletionsErrorKind = GenerateCompletionsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for GenerateCompletionsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::generate_completions::GenerateCompletionsError {
...
impl GenerateCompletionsError {
    ...
    /// Creates the `GenerateCompletionsError::Unhandled` variant from a
