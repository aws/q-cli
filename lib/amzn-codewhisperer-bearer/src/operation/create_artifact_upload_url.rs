...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for CreateArtifactUploadUrlResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for CreateArtifactUploadUrlRequestSerializer {
    #[allow(
        unused_mut,
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateArtifactUploadUrlEndpointParamsInterceptor {
...
pub type CreateArtifactUploadUrlErrorKind = CreateArtifactUploadUrlError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateArtifactUploadUrlError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_artifact_upload_url::CreateArtifactUploadUrlError {
...
impl CreateArtifactUploadUrlError {
    ...
    /// Creates the `CreateArtifactUploadUrlError::Unhandled` variant from a
