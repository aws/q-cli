...
class FileSystem {
  ...
  static func appendToFile(_ request: Fig_AppendToFileRequest) throws -> Bool {
    ...
    guard let fileHandle = FileHandle(forWritingAtPath: path) else {
      throw APIError.generic(message: "No file exists at path")
    }
  ...
  static func destinationOfSymbolicLink(_ request: Fig_DestinationOfSymbolicLinkRequest)
      throws -> Fig_DestinationOfSymbolicLinkResponse {
