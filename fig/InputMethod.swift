...
class InputMethod {
    ...
    static let `default` = InputMethod(bundlePath: Bundle.main.url(forAuxiliaryExecutable: "FigInputMethod.app")!.path)//Bundle.main.path(forResource: "FigInputMethod", ofType: "app")!)
